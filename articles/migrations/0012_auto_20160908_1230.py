...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='articles.StandardValue'),
        ),
        migrations.AlterField(
            model_name='samplesattributenameinexperiment',
            name='unificated_name',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='articles.StandardName'),
        ),
    ]
